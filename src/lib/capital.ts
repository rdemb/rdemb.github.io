...
export const capitalI18n: Record<Lang, CapData> = {
  pl: {
    ...
    methods: [
      { n: 'Dane u źródła', p: 'Fundamenty pochodzą prosto ze sprawozdań spółki (SEC EDGAR, 10-K/10-Q). Wskaźniki liczymy sami, a warstwa kontroli odrzuca artefakty i podaje źródło oraz pewność każdej liczby.' },
  ...
  en: {
    ...
    methods: [
      { n: 'Data at the source', p: "Fundamentals come straight from the company's filings (SEC EDGAR, 10-K/10-Q). We compute the ratios ourselves, and a control layer rejects artifacts and records the source and confidence of every number." },
  ...
  de: {
    ...
    methods: [
      { n: 'Daten an der Quelle', p: 'Die Fundamentaldaten stammen direkt aus den Berichten des Unternehmens (SEC EDGAR, 10-K/10-Q). Die Kennzahlen berechnen wir selbst, und eine Kontrollschicht verwirft Artefakte und vermerkt Quelle sowie Konfidenz jeder Zahl.' },
