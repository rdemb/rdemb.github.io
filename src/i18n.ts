...
export const ui = {
  pl: {
    'nav.home': 'Start', 'nav.about': 'O mnie', 'nav.work': 'Oferta', 'nav.pracownia': 'Pracownia', 'nav.projects': 'Projekty', 'nav.zywy': 'Żywy algorytm', 'nav.blog': 'Blog', 'nav.contact': 'Kontakt',
  ...
  en: {
    'nav.home': 'Home', 'nav.about': 'About', 'nav.work': 'Services', 'nav.pracownia': 'Workshop', 'nav.projects': 'Projects', 'nav.zywy': 'Living algorithm', 'nav.blog': 'Blog', 'nav.contact': 'Contact',
  ...
  de: {
    'nav.home': 'Start', 'nav.about': 'Über mich', 'nav.work': 'Leistungen', 'nav.pracownia': 'Werkstatt', 'nav.projects': 'Projekte', 'nav.zywy': 'Lebender Algorithmus', 'nav.blog': 'Blog', 'nav.contact': 'Kontakt',
