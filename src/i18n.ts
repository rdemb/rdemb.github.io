...
export const ui = {
  pl: {
    'nav.about': 'O mnie', 'nav.work': 'Oferta', 'nav.projects': 'Projekty', 'nav.lab': 'Pracownia', 'nav.blog': 'Blog', 'nav.contact': 'Kontakt',
  ...
  en: {
    'nav.about': 'About', 'nav.work': 'Services', 'nav.projects': 'Projects', 'nav.lab': 'Workshop', 'nav.blog': 'Blog', 'nav.contact': 'Contact',
  ...
  de: {
    'nav.about': 'Über mich', 'nav.work': 'Leistungen', 'nav.projects': 'Projekte', 'nav.lab': 'Werkstatt', 'nav.blog': 'Blog', 'nav.contact': 'Kontakt',
