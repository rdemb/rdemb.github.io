...
Pliki z tego wpisu: [test_placebo.py](/code/test_placebo.py) z działającym demo i [syntetyczny CSV](/code/EURUSD_H1_syntetyk.csv) do ćwiczeń. Zabawkowa reguła w demo uczciwie wychodzi na p równe 0.355, czyli losowanie, i o to chodzi: zobacz, jak wygląda brak przewagi, zanim zaczniesz szukać prawdziwej.
