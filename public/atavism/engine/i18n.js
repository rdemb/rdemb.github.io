...
(function () {
  ...
  const DICT = {
    ...
    // ---- wyszukiwanie w archiwach (droga BEZ DNA) ----
    'arch.find':     { pl: 'Znajdź przodków',       en: 'Find ancestors',          de: 'Ahnen finden' },
    'arch.title':    { pl: 'Znajdź przodków',       en: 'Find ancestors',          de: 'Ahnen finden' },
    'arch.sub':      { pl: 'Powiedz co wiesz — przeszukamy archiwa', en: 'Tell us what you know — we search the archives', de: 'Sag, was du weißt — wir durchsuchen die Archive' },
    'arch.surname':  { pl: 'Nazwisko',              en: 'Surname',                 de: 'Nachname' },
    'arch.province': { pl: 'Województwo / region',  en: 'Province / region',       de: 'Woiwodschaft / Region' },
    'arch.recType':  { pl: 'Rodzaj aktu',           en: 'Record type',             de: 'Aktenart' },
    'arch.tBirth':   { pl: 'urodzenia',             en: 'births',                  de: 'Geburten' },
    'arch.tMarriage':{ pl: 'śluby',                 en: 'marriages',               de: 'Heiraten' },
    'arch.tDeath':   { pl: 'zgony',                 en: 'deaths',                  de: 'Sterbefälle' },
    'arch.yearFrom': { pl: 'rok od',                en: 'year from',               de: 'Jahr von' },
    'arch.yearTo':   { pl: 'rok do',                en: 'year to',                 de: 'Jahr bis' },
    'arch.firstname':{ pl: 'Imię (opcjonalnie)',    en: 'First name (optional)',   de: 'Vorname (optional)' },
    'arch.searchBtn':{ pl: 'Szukaj w archiwach',    en: 'Search the archives',     de: 'Archive durchsuchen' },
    'arch.searching':{ pl: 'Szukam w Genetece…',    en: 'Searching Geneteka…',     de: 'Durchsuche Geneteka…' },
    'arch.found':    { pl: 'Znaleziono {total} aktów · pokazuję {shown}', en: 'Found {total} records · showing {shown}', de: '{total} Akten gefunden · zeige {shown}' },
    'arch.none':     { pl: 'Brak aktów. Spróbuj inny region, szerszy zakres lat lub samo nazwisko.', en: 'No records. Try another region, a wider year range, or just the surname.', de: 'Keine Akten. Versuch eine andere Region, weiteren Zeitraum oder nur den Nachnamen.' },
    'arch.needPlace':{ pl: 'Podaj nazwisko i region — bez miejsca nie da się szukać aktów.', en: 'Enter a surname and region — records cannot be searched without a place.', de: 'Nachname und Region angeben — ohne Ort keine Aktensuche.' },
    'arch.error':    { pl: 'Nie udało się połączyć z archiwami. Spróbuj za chwilę.', en: 'Could not reach the archives. Try again shortly.', de: 'Archive nicht erreichbar. Bitte gleich erneut versuchen.' },
    'arch.offline':  { pl: 'Wyszukiwarka działa na opublikowanej stronie, nie z pliku lokalnego.', en: 'Search works on the published site, not from a local file.', de: 'Die Suche läuft auf der veröffentlichten Seite, nicht aus einer lokalen Datei.' },
    'arch.load':     { pl: 'Wczytaj do organizmu',  en: 'Grow the organism',       de: 'Organismus wachsen lassen' },
    'arch.deeper':   { pl: 'kop głębiej',           en: 'dig deeper',              de: 'tiefer graben' },
    'arch.parents':  { pl: 'rodzice',               en: 'parents',                 de: 'Eltern' },
    'arch.scan':     { pl: 'skan',                  en: 'scan',                    de: 'Scan' },
    'arch.note':     { pl: 'Imiona z indeksacji Geneteki — potwierdź oryginalnym skanem. Pochodzenie i linie Y/mt wymagają DNA.', en: 'Names from Geneteka indexing — confirm with the original scan. Ancestry and Y/mt lines need DNA.', de: 'Namen aus der Geneteka-Indexierung — mit Original-Scan bestätigen. Herkunft und Y/mt-Linien brauchen DNA.' },
    'arch.profileSuffix': { pl: '(z archiwów)',     en: '(from archives)',         de: '(aus Archiven)' },
    'arch.noDna':    { pl: 'pochodzenie — wymaga DNA', en: 'ancestry — needs DNA',  de: 'Herkunft — DNA nötig' },
